...
func Jurnalplunahm(c *fiber.Ctx) error {
	var (
	...
	dt, err := jurnalPLUnahm(startdate, enddate, idstore)
	if err != nil {
...
func jurnalPLUnahm(startdate, enddate, idstore string) ([]isoide.Plusummary, error) {
